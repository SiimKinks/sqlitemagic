...
/**
 * Marks a function that transforms an object into a database-compatible value.
 *
 ...
 * containing the transformed object and return a supported SQLite storage type. The paired
 * [DbValueToObject] function must accept that serialized type and return the transformed type.
...
@Target(FUNCTION)
@Retention(BINARY)
annotation class ObjectToDbValue
