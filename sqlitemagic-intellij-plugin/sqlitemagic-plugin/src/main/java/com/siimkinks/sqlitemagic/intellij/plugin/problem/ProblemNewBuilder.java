...
public class ProblemNewBuilder implements ProblemBuilder {
  private Set<SqliteMagicProblem> problems;
  ...
  public ProblemNewBuilder(int size) {
    this.problems = new HashSet<SqliteMagicProblem>(size);
  }

  public Set<SqliteMagicProblem> getProblems() {
    return problems;
  }
  ...
  public void addProblem(String message, ProblemHighlightType highlightType, LocalQuickFix... quickFixes) {
    problems.add(new SqliteMagicProblem(message, highlightType, quickFixes));
  }
}
